...
//    	daoLivre.save(new Livre(null,"Bases JPA Hibernete" , "Didier", "First"));
		...
		Exemplaire exemplaire13 = daoExemplaire.save(
					new Exemplaire(null, Exemplaire.EtatLivre.HORS_SERVICE, "exemlpaire13", livre1));
		...
		Exemplaire exemplaire22 = daoExemplaire.save(
					new Exemplaire(null, Exemplaire.EtatLivre.HORS_SERVICE, "exemlpaire22", livre2));
		...
		Exemplaire exemplaire32 = daoExemplaire.save(
					new Exemplaire(null, Exemplaire.EtatLivre.HORS_SERVICE, "exemlpaire32", livre3));
		exemplaire32.setIsDisponibilite(false);
		daoExemplaire.save(exemplaire32);

		Livre livre4 = daoLivre
					.save(new Livre(null, "Bases JPA Hibernete", "Didier", "First", domaine1));
		...
		Exemplaire exemplaire42 = daoExemplaire.save(
					new Exemplaire(null, Exemplaire.EtatLivre.HORS_SERVICE, "exemlpaire42", livre4));
		...
		Livre livre5 = daoLivre.save(new Livre(null, "Le tour du monde en 80 jours", "Paul et Virginie",
					"Harmathan", domaine4));
		Livre livre6 = daoLivre
					.save(new Livre(null, "Les misérables", "Victor Hugo", "Harmathan", domaine4));
		Livre livre7 = daoLivre
					.save(new Livre(null, "Père Goriot", "Eugène Rastignac", "Harmathan", domaine4));
		Livre livre8 = daoLivre
					.save(new Livre(null, "Les trois mousquetaires", "Artagnan", "Harmathan", domaine4));
		Livre livre9 = daoLivre.save(new Livre(null, "La joie de vivre", "Zola", "Harmathan", domaine4));
		Livre livre10 = daoLivre.save(
					new Livre(null, "L'Enfance d'un chef", "Jean Paul Sartre", "Harmathan", domaine4));

		Exemplaire exemplaire51 = daoExemplaire
					.save(new Exemplaire(null, EtatLivre.BON_ETAT, "exemplaire51", livre5));
		exemplaire51.setIsDisponibilite(true);
		daoExemplaire.save(exemplaire51);

		Exemplaire exemplaire52 = daoExemplaire
					.save(new Exemplaire(null, EtatLivre.ABIME, "exemplaire52", livre5));
		exemplaire52.setIsDisponibilite(true);
		daoExemplaire.save(exemplaire52);
		Lecteur lecteur1 = daoLecteur.save(new Lecteur(null, "Roger", "dupont", "dupont@inetum.fr",
					"1234", "0754865211", "paris"));
		Lecteur lecteur2 = daoLecteur.save(new Lecteur(null, "Julie", "DesaintLeger", "julie@inetum.fr",
					"1234", "0754865211", "seine saint denis"));
		Lecteur lecteur3 = daoLecteur.save(new Lecteur(null, "Victor", "Sicard", "victor@inetum.fr",
					"1234", "0754865211", "Antony"));
		Lecteur lecteur4 = daoLecteur.save(new Lecteur(null, "Raphael", "Farina", "raphael@inetum.fr",
					"1234", "0754865211", "Sarcelle"));
		Lecteur lecteur5 = daoLecteur.save(new Lecteur(null, "Thibaud", "Glutron", "thibaud@inetum.fr",
					"1234", "0754865211", "Antony"));
		Lecteur lecteur6 = daoLecteur.save(new Lecteur(null, "Frederic", "Ros", "frederic@inetum.fr",
					"1234", "0754865211", "seine saint denis"));
		Lecteur lecteur7 = daoLecteur.save(new Lecteur(null, "Simon", "Granier", "simon@inetum.fr",
					"1234", "0754865211", "Fontanay aux roses"));
		Lecteur lecteur8 = daoLecteur.save(new Lecteur(null, "Roland", "Panzou", "roland@inetum.fr",
					"1234", "0754865211", "ile-de-france"));
		Lecteur lecteur9 = daoLecteur.save(new Lecteur(null, "Soulef", "Saoud", "soulef@inetum.fr",
					"1234", "0754865211", "ile-de-france"));
		Lecteur lecteur10 = daoLecteur.save(new Lecteur(null, "Anouar", "El Idrissi", "anouar@inetum.fr",
					"1234", "0754865211", "cergy pontoise"));

		Administrateur admin1 = daoAdmin.save(new Administrateur(null, "Jean", "valjean",
					"jean@boite.fr", "1234", "0698574123", "Paris 11", "j.valjean"));
		Administrateur admin2 = daoAdmin.save(new Administrateur(null, "Toto", "dupond", "toto@boite.fr",
					"1234", "0698574123", "Paris 11", "toto"));
		...
		try {
			...
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur1, exemplaire52));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur1, exemplaire42));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur1, exemplaire12));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur1, exemplaire41));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur10, exemplaire42));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur10, exemplaire12));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur10, exemplaire52));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur3, exemplaire42));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur3, exemplaire12));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-09-26"), TypeEmprunt.RESERVE, lecteur3, exemplaire52));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur6, exemplaire13));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur6, exemplaire32));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur7, exemplaire52));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur7, exemplaire42));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur7, exemplaire12));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur8, exemplaire52));

			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.RESERVE, lecteur8, exemplaire42));
			daoEmpruntJpa.save(new Emprunter(null, format.parse("2023-08-13"),
						format.parse("2023-08-23"), TypeEmprunt.EFFECTIF, lecteur8, exemplaire12));
